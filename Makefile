...
build_all:
	...
	@flex -o lexer.cpp lexer.lpp
# -ferror-limit=100
	@g++ -std=c++17 -ferror-limit=100 -o parser main.cpp ast.cpp ./semantic/semantic.cpp ./semantic/java_entity_visitor.cpp ./semantic/java_entity.cpp ./utils/dot_visitor.cpp
